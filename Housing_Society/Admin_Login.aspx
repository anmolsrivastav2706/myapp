<%@ Page Title="" Language="C#" MasterPageFile="~/UserPage.master" AutoEventWireup="true" CodeFile="Admin_Login.aspx.cs" Inherits="Admin_Login" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <table class="style1">
        <caption class="style2">
            <strong>ADMIN LOGIN</strong></caption>
        <tr>
            <td>
                &nbsp;</td>
            <td class="style3">
        ...
        <tr>
            ...
            <td>
                <asp:ImageButton ID="btn_login" runat="server" Height="61px" 
                    ImageUrl="~/PICS/128x128/036.png" onclick="btn_login_Click" ToolTip="LOGIN" 
                    Width="74px" />
            </td>
            <td>
                &nbsp;</td>
